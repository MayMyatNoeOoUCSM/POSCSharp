...
namespace POS_Admin.Views.Report
{
    public partial class UCSaleReport : UserControl
    {
        ...
        {
            Consts.REPORTNAME = "RptSaleListReport";
        ...
        private void GetCurrentPageRecords(int currentPage)
        {
            ...
            dgvSaleReport.DataSource = dtResult;
        ...
        private void CustomizeThemes()
        {
            ...
            dgvSaleReport.ColumnHeadersDefaultCellStyle.BackColor = Properties.Settings.Default.BackColor;
        }
        #endregion
        ...
        private void UCSaleReport_Load(object sender, EventArgs e)
        {
            ...
            dtSaleList = saleService.GetTotalSale();
            if (dtSaleList.Rows.Count > 0)
            {
                lblNoSaleList.Visible = false;
                dgvSaleReport.DataSource = dtSaleList;
                ShowDetails();
            }
            else
            {
            ...
            dgvSaleReport.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(238, 239, 250);
            localization.UCChangeLanguageText(Consts.LANGUAGEID, this, uCSaleReport);
            localization.ChangeDatagridText(dgvSaleReport);
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            searchTotalCount = saleService.GetSearchCountReport(getFilterList);
            dtSearchResult = saleService.GetSearchResultForReportList(getFilterList);
            dgvSaleReport.DataSource = dtSearchResult;
        ...
        {
            dgvSaleReport.CurrentCell.Selected = false;
        }
        ...
        private void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            var dtExcelDataTable = saleService.GetXLSXData();
            ...
            string newFileName = (count == 0) ? "SaleReport.xlsx"
