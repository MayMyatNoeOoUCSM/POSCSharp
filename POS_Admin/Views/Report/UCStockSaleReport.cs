...
{
    public partial class UCStockSaleReport : UserControl
    {
        ...
        {
            Consts.REPORTNAME = "RPTINVENTORYSTOCKPRODUCT";
            dsReport = stockService.GetRptSaleStockList();
        }
        ...
        {
            dgvStockSaleReport.Visible = true;
        ...
        private void GetCurrentPageRecords(int currentPage)
        {
            ...
            dgvStockSaleReport.DataSource = dtResult;
        ...
        private void CustomizeThemes()
        {
            ...
            dgvStockSaleReport.ColumnHeadersDefaultCellStyle.BackColor = Properties.Settings.Default.BackColor;
        }
        #endregion
        ...
        /// <summary>
        /// UCStockSaleReport_Load
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UCStockSaleReport_Load(object sender, EventArgs e)
        {
            UCStockSaleReport uCStockSaleReport = new UCStockSaleReport();
            dtSaleList = stockService.GetSaleStockLists();
            if (dtSaleList.Rows.Count > 0)
            {
                dgvStockSaleReport.DataSource = dtSearchResult;
                ShowDetails();
            }
            else
            {
            ...
            dgvStockSaleReport.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(238, 239, 250);
            localization.UCChangeLanguageText(Consts.LANGUAGEID, this, uCStockSaleReport);
            localization.ChangeDatagridText(dgvStockSaleReport);
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (changeFromDate != 0 || changeToDate != 0)
            {
                dtSearchResult = stockService.GetSearchResultForStockSaleReportList(getFilterList);
            }
            else
            {
                dtSearchResult = dtSaleList;
            }
            ...
            else
            {
                if (DAO.Common.Consts.LANGUAGEID == 1)
                {
                    MessageBox.Show(DAO.Common.Messages.W0100, DAO.Common.Messages.T0002, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
                    MessageBox.Show(DAO.Common.Messages.B0031, DAO.Common.Messages.F0002, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                HideDetails();
            }
        }
        ...
        /// <summary>
        /// dgvStockSaleReport_CellFormatting
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void dgvStockSaleReport_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            dgvStockSaleReport.CurrentCell.Selected = false;
        }
        ...
        private void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            var dtExcelDataTable = stockService.GetXLSXData();
            ...
            string fileName = "StockSaleReport";
            int count = files.Count(file => { return file.Contains(fileName); });
            string newFileName = (count == 0) ? "StockSaleReport.xlsx"
        ...
        /// <summary>
        /// dgvStockSaleReport_RowPostPaint
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void dgvStockSaleReport_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        {
            ...
            //         dgvStockSaleReport.DefaultCellStyle.Font, r, g.RowHeadersDefaultCellStyle.ForeColor);
        }
